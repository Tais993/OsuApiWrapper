...
public enum ModV1 {
    ...
    ModV1(int bitwise, String title, String abbreviation) {
        this.bitwise = bitwise;
        this.title = title;
        this.abbreviation = abbreviation;
    }

    ModV1(int id, String title, String abbreviation, String... types) {
        this.bitwise = id;
        this.title = title;
        this.abbreviation = abbreviation;
    ...
    public static ArrayList<ModV1> getByBitwise(int bitwiseInt) {

        ArrayList<ModV1> modV1s = new ArrayList<>();

        final AtomicInteger bitwise = new AtomicInteger(bitwiseInt);
        while (bitwise.get() != 0) {

            Arrays.stream(ModV1.values())
    ...
    public static int getBitwiseFromMods(ArrayList<ModV1> modV1s) {
        return modV1s.stream().mapToInt(ModV1::getBitwise).sum();
    }
